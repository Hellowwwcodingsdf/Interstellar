...
if (nav) {
  ...
  const html = `
    ...
    <div class="fixed-nav-bar-right">
      <a class="navbar-link" href="/./gm"><i class="fa-solid fa-gamepad navbar-icon"></i><an>TreeGa</an><an>mes</an></a>
      <a class="navbar-link" href="/./as"><i class="fa-solid fa-phone navbar-icon"></i><an>TreeAp</an><an>ps</an></a>
      <a class="navbar-link" href="/./ts"><i class="fa-solid fa-folder navbar-icon"></i><an>TreeTo</an><an>ols</an></a>
      ${window.top.location.pathname === "/ta" ? "" : '<a class="navbar-link" href="/./ta"><i class="fa-solid fa-laptop navbar-icon"></i><an>TreeTa</an><an>bs</an></a>'}
      <a class="navbar-link" href="/./st"><i class="fa-solid fa-gear navbar-icon settings-icon"></i><an>TreeSet</an><an>tings</an></a>
    </div>`;
  nav.innerHTML = html;
}
